      ...
      {cartItemsCount}
                        ...
                        {isAuthenticated ? (
                            <div className="relative group">
                                <div className="h-11 w-11 rounded-full bg-gradient-to-br from-amber-400 via-yellow-500 to-orange-600 shadow-lg shadow-yellow-500/40 text-black font-bold flex items-center justify-center cursor-pointer">
                                    {user?.name?.charAt(0).toUpperCase()}
                                </div>

                                {/* Dropdown */}
                                <div className="absolute right-0 mt-3 w-56 rounded-2xl bg-white dark:bg-zinc-900 shadow-2xl border border-white/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                                    ...
                                    <Link
                                        to="/profile"
                                        className="block px-4 py-2 text-sm hover:bg-amber-50 dark:hover:bg-zinc-800"
                                    >
                                        My Profile
                                    </Link>
                                    ...
                                    {user?.role === "admin" && (
                                        <>
                                            <div className="px-4 pt-2 text-xs uppercase text-gray-400">
                                                Admin
                                            </div>
                                            <Link
                                                to="/admin/dashboard"
